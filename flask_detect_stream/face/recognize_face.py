...
# 人脸识别 入参是numpy.ndarray, RGB, float64 in [0,1]
# 这里假设输入的face_img是DeepFace.extract_faces提取的人脸图
# 注意：DeepFace.extract_faces返回的是一个列表，每个元素是一个字典，
# 包含键 "face" 对应的值是人脸图像的numpy数组
# 这里的face_img应该是提取出来的单个人脸图像
# 例如：face_img = face_imgs[0]["face"]，其中face_imgs是DeepFace.extract_faces的返回值
# 这里的face_img应该是一个numpy.ndarray，形状为(H, W, 3)，数据类型为float64，值范围在[0, 1]之间 
